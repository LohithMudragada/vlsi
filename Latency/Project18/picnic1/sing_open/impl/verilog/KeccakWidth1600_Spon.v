...
wire   [15:0] tmp_44_cast_fu_318_p3;
reg   [15:0] tmp_44_cast_reg_614;
wire   [0:0] icmp_ln297_fu_326_p2;
reg   [0:0] icmp_ln297_reg_620;
reg   [7:0] instance_state_addr_reg_624;
wire   [7:0] instance_state_addr_1_reg_629;
wire    ap_CS_fsm_state3;
reg   [33:0] i_27_load_reg_642;
...
wire   [7:0] loop_49_fu_434_p2;
reg   [7:0] loop_49_reg_669;
wire    ap_CS_fsm_state10;
wire   [6:0] trunc_ln394_2_fu_445_p1;
reg   [6:0] trunc_ln394_2_reg_674;
wire   [0:0] icmp_ln393_1_fu_428_p2;
wire   [63:0] add_ln310_fu_449_p2;
wire   [63:0] j_15_fu_455_p2;
...
wire   [31:0] partialBlock_19_fu_524_p3;
reg   [31:0] partialBlock_19_reg_699;
...
reg   [31:0] ap_phi_mux_instance_byteIOIndex_72_phi_fu_165_p4;
reg   [31:0] instance_byteIOIndex_72_reg_162;
...
reg   [31:0] offset_assign_1_reg_229;
...
wire   [63:0] zext_ln394_1_fu_440_p1;
wire   [63:0] zext_ln394_16_fu_489_p1;
wire   [63:0] zext_ln394_fu_562_p1;
wire   [63:0] zext_ln394_14_fu_598_p1;
reg   [33:0] i_27_fu_74;
wire   [33:0] sub_ln312_fu_417_p2;
wire    ap_CS_fsm_state2;
wire   [7:0] xor_ln149_fu_337_p2;
wire    ap_CS_fsm_state4;
wire   [7:0] xor_ln149_1_fu_344_p2;
wire   [9:0] tmp_fu_294_p3;
wire   [10:0] zext_ln394_12_fu_302_p1;
wire   [10:0] zext_ln394_11_fu_290_p1;
wire   [10:0] sub_ln394_fu_306_p2;
wire   [10:0] zext_ln394_10_fu_286_p1;
wire   [10:0] add_ln394_9_fu_312_p2;
wire   [28:0] tmp_51_fu_359_p4;
...
wire   [6:0] trunc_ln302_4_fu_470_p1;
wire   [6:0] add_ln394_3_fu_465_p2;
wire   [6:0] add_ln394_2_fu_474_p2;
wire   [15:0] zext_ln394_15_fu_480_p1;
wire   [15:0] add_ln394_11_fu_484_p2;
wire   [5:0] trunc_ln320_fu_494_p1;
wire   [31:0] zext_ln320_fu_503_p1;
wire   [31:0] add_ln321_fu_506_p2;
wire   [0:0] icmp_ln321_fu_512_p2;
wire   [31:0] partialBlock_18_fu_518_p2;
wire   [33:0] zext_ln323_4_fu_536_p1;
wire   [31:0] add_ln394_fu_556_p2;
wire   [6:0] trunc_ln302_fu_580_p1;
wire   [6:0] add_ln394_1_fu_584_p2;
wire   [15:0] zext_ln394_13_fu_589_p1;
wire   [15:0] add_ln394_10_fu_593_p2;
reg   [15:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln393_1_fu_428_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln297_reg_620 == 1'd1) & (1'b1 == ap_CS_fsm_state6) & (1'b0 == ap_block_state6_on_subcall_done))) begin
        instance_byteIOIndex_72_reg_162 <= 32'd0;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        tmp_44_cast_reg_614[15 : 5] <= tmp_44_cast_fu_318_p3[15 : 5];
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln393_1_fu_428_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (*) begin
    if (((icmp_ln297_reg_620 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
        ap_phi_mux_instance_byteIOIndex_72_phi_fu_165_p4 = 32'd0;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        data_address0 = zext_ln394_14_fu_598_p1;
    end else if ((1'b1 == ap_CS_fsm_state11)) begin
        data_address0 = zext_ln394_16_fu_489_p1;
    end else begin
        data_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state14)) begin
        ...
        instance_state_address0 = zext_ln394_1_fu_440_p1;
...
assign add_ln321_fu_506_p2 = (zext_ln320_fu_503_p1 + offset_assign_1_reg_229);

assign add_ln329_fu_603_p2 = (curData_1_rec_pn_reg_266 + curData_0_idx_reg_184);

assign add_ln330_fu_571_p2 = (offset_assign_1_reg_229 + partialBlock_19_reg_699);

assign add_ln394_10_fu_593_p2 = (tmp_44_cast_reg_614 + zext_ln394_13_fu_589_p1);

assign add_ln394_11_fu_484_p2 = (tmp_44_cast_reg_614 + zext_ln394_15_fu_480_p1);

assign add_ln394_1_fu_584_p2 = (trunc_ln394_reg_728 + trunc_ln302_fu_580_p1);

assign add_ln394_2_fu_474_p2 = (trunc_ln302_4_fu_470_p1 + add_ln394_3_fu_465_p2);

assign add_ln394_3_fu_465_p2 = (trunc_ln394_2_reg_674 + trunc_ln304_fu_461_p1);

assign add_ln394_9_fu_312_p2 = (sub_ln394_fu_306_p2 + zext_ln394_10_fu_286_p1);

assign add_ln394_fu_556_p2 = (offset_assign_1_reg_229 + loop_0_i1_reg_242);
...
assign i_fu_540_p2 = (zext_ln323_4_fu_536_p1 + i_27_load_reg_642);

assign icmp_ln297_fu_326_p2 = ((instance_squeezing_read == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln302_fu_369_p2 = ((tmp_51_fu_359_p4 == 29'd0) ? 1'b1 : 1'b0);
...
assign icmp_ln393_1_fu_428_p2 = ((loop_0_i_reg_218 == 8'd168) ? 1'b1 : 1'b0);

assign icmp_ln393_fu_545_p2 = ((loop_0_i1_reg_242 == partialBlock_19_reg_699) ? 1'b1 : 1'b0);

assign instance_state_addr_1_reg_629 = 64'd167;

assign j_15_fu_455_p2 = ($signed(j_0_reg_196) + $signed(64'd18446744073709551448));

assign j_fu_397_p2 = (34'd32 - i_27_fu_74);

assign loop_49_fu_434_p2 = (loop_0_i_reg_218 + 8'd1);

assign loop_fu_550_p2 = (loop_0_i1_reg_242 + 32'd1);

assign partialBlock_18_fu_518_p2 = (32'd168 - offset_assign_1_reg_229);

assign partialBlock_19_fu_524_p3 = ((icmp_ln321_fu_512_p2[0:0] === 1'b1) ? partialBlock_18_fu_518_p2 : zext_ln320_fu_503_p1);
...
assign sub_ln394_fu_306_p2 = (zext_ln394_12_fu_302_p1 - zext_ln394_11_fu_290_p1);

assign tmp_44_cast_fu_318_p3 = {{add_ln394_9_fu_312_p2}, {5'd0}};

assign tmp_51_fu_359_p4 = {{i_27_fu_74[33:5]}};

assign tmp_fu_294_p3 = {{data_offset}, {2'd0}};

assign trunc_ln302_4_fu_470_p1 = curData_0_idx_reg_184[6:0];

assign trunc_ln302_fu_580_p1 = curData_0_idx_reg_184[6:0];

assign trunc_ln303_fu_381_p1 = i_27_fu_74[29:0];

assign trunc_ln304_fu_461_p1 = curData_1_rec_reg_206[6:0];

assign trunc_ln312_fu_413_p1 = j_0_reg_196[33:0];

assign trunc_ln320_fu_494_p1 = i_27_load_reg_642[5:0];

assign trunc_ln394_2_fu_445_p1 = loop_0_i_reg_218[6:0];

assign trunc_ln394_fu_567_p1 = loop_0_i1_reg_242[6:0];

assign xor_ln149_1_fu_344_p2 = (instance_state_q0 ^ 8'd128);
...
assign zext_ln323_4_fu_536_p1 = partialBlock_19_fu_524_p3;

assign zext_ln323_fu_532_p1 = partialBlock_19_fu_524_p3;

assign zext_ln394_10_fu_286_p1 = data_offset1;

assign zext_ln394_11_fu_290_p1 = data_offset;

assign zext_ln394_12_fu_302_p1 = tmp_fu_294_p3;

assign zext_ln394_13_fu_589_p1 = add_ln394_1_fu_584_p2;

assign zext_ln394_14_fu_598_p1 = add_ln394_10_fu_593_p2;

assign zext_ln394_15_fu_480_p1 = add_ln394_2_fu_474_p2;

assign zext_ln394_16_fu_489_p1 = add_ln394_11_fu_484_p2;

assign zext_ln394_1_fu_440_p1 = loop_0_i_reg_218;

assign zext_ln394_fu_562_p1 = add_ln394_fu_556_p2;

always @ (posedge ap_clk) begin
    tmp_44_cast_reg_614[4:0] <= 5'b00000;
