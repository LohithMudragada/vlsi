...
architecture behav of KeccakP1600_Permute_s is 
    ...
    signal i_28_fu_246_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_28_reg_538 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal i_29_fu_330_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal i_29_reg_575 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal shl_ln5_fu_475_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal shl_ln5_reg_639 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal j_16_fu_493_p2 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal shl_ln6_fu_368_p3 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state17)) then
                    shl_ln5_reg_639(7 downto 3) <= shl_ln5_fu_475_p3(7 downto 3);
    ...
    shl_ln5_reg_639(2 downto 0) <= "000";
    ...
    add_ln282_fu_525_p2 <= std_logic_vector(unsigned(shl_ln5_reg_639) + unsigned(zext_ln281_fu_483_p1));
    add_ln353_1_fu_385_p2 <= std_logic_vector(unsigned(shl_ln6_fu_368_p3) + unsigned(zext_ln353_2_fu_381_p1));
    ...
    i_28_fu_246_p2 <= std_logic_vector(unsigned(i_0_i_reg_145) + unsigned(ap_const_lv5_1));
    i_29_fu_330_p2 <= std_logic_vector(unsigned(indexRound_assign_reg_168) + unsigned(ap_const_lv5_1));
    ...
    j_16_fu_493_p2 <= std_logic_vector(unsigned(j_0_i5_reg_214) + unsigned(ap_const_lv4_1));
    ...
    shl_ln5_fu_475_p3 <= (i_0_i3_reg_202 & ap_const_lv3_0);
    shl_ln6_fu_368_p3 <= (y_0_i_reg_191 & ap_const_lv2_0);
