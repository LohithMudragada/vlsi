...
// ==============================================================
# 1 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
# 1 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c" 2
# 16 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
...
# 17 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c" 2
# 65 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
...
# 94 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
...
# 120 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
...
# 134 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    KeccakP1600_Permute_24rounds(state);
...
# 206 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
...
int KeccakWidth1600_SpongeAbsorbLastFewBits(KeccakWidth1600_SpongeInstance *instance, unsigned char delimitedData)
{
    ...
    if (instance->squeezing)
        return 1;
# 265 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
...
# 279 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    KeccakP1600_Permute_24rounds(instance->state);
    instance->byteIOIndex = 0;
...
# 402 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
int KeccakWidth1600_12rounds_Sponge(unsigned int rate, unsigned int capacity, const unsigned char *input, size_t inputByteLen, unsigned char suffix, unsigned char *output, size_t outputByteLen)
{
    ...
    if (suffix == 0)
        return 1;
                          ...
                          ;
    KeccakP1600_Initialize(state);
# 431 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    while(inputByteLen >= (size_t)rateInBytes) {
    ...
    KeccakP1600_AddBytes(state, curInput, 0, partialBlock);
# 457 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    KeccakP1600_AddByte(state, suffix, partialBlock);
    ...
    KeccakP1600_AddByte(state, 0x80, rateInBytes-1);
# 471 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    KeccakP1600_Permute_12rounds(state);
...
int KeccakWidth1600_12rounds_SpongeAbsorb(KeccakWidth1600_12rounds_SpongeInstance *instance, const unsigned char data[200], size_t dataByteLen)
{
    ...
    while(i < dataByteLen) {
        if ((instance->byteIOIndex == 0) && (dataByteLen >= (i + rateInBytes))) {
# 543 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
                for(j=dataByteLen-i; j>=rateInBytes; j-=rateInBytes) {
...
int KeccakWidth1600_12rounds_SpongeAbsorbLastFewBits(KeccakWidth1600_12rounds_SpongeInstance *instance, unsigned char delimitedData)
{
    ...
    if (instance->squeezing)
        return 1;
# 602 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    KeccakP1600_AddByte(instance->state, delimitedData, instance->byteIOIndex);
    ...
    KeccakP1600_AddByte(instance->state, 0x80, rateInBytes-1);
# 616 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakSpongeWidth1600.c"
    KeccakP1600_Permute_12rounds(instance->state);
    instance->byteIOIndex = 0;
    instance->squeezing = 1;
