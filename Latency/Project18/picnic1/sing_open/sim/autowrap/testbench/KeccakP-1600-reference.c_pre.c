# 1 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
# 1 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 2
# 16 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
...
# 17 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 2
...
# 18 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 2
...
# 19 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 2
...
# 20 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 2
# 1 "C:/Users/Sanil/Downloads/Project18/sha3/brg_endian.h" 1
# 21 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c" 2
...
# 98 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
...
{
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",148),0));
    state[offset] ^= byte;
}
...
{
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",168),0));
    (void) ((!!(offset+length <= 200)) || (_assert("offset+length <= 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",169),0));
...
{
    (void) ((!!(byteCount <= 200)) || (_assert("byteCount <= 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",177),0));
...
{
# 203 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
    KeccakP1600OnWords((tKeccakLane*)state, nrounds);
# 212 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
}

void KeccakP1600_Permute_12rounds(unsigned char *state)
{
# 224 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
    KeccakP1600OnWords((tKeccakLane*)state, 12);
# 233 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
}
...
# 256 "C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c"
...
{
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",389),0));
    (void) ((!!(offset+length <= 200)) || (_assert("offset+length <= 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",390),0));
...
void KeccakP1600_ExtractAndAddBytes(const unsigned char *state, const unsigned char *input, unsigned char *output, unsigned int offset, unsigned int length)
{
    ...
    (void) ((!!(offset < 200)) || (_assert("offset < 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",403),0));
    (void) ((!!(offset+length <= 200)) || (_assert("offset+length <= 200","C:/Users/Sanil/Downloads/Project18/sha3/KeccakP-1600-reference.c",404),0));
    for(i=0; i<length; i++)
