...
{_ssdm_SpecArrayDimSize(pk, 33);_ssdm_SpecArrayDimSize(sk, 49);
...
{_ssdm_SpecArrayDimSize(sm, 37336);_ssdm_SpecArrayDimSize(smlen, 1);_ssdm_SpecArrayDimSize(m, 3300);_ssdm_SpecArrayDimSize(sk, 49);
    picnic_privatekey_t secret;
    int loop;
...
{_ssdm_SpecArrayDimSize(m, 3300);_ssdm_SpecArrayDimSize(mlen, 1);_ssdm_SpecArrayDimSize(sm, 37336);_ssdm_SpecArrayDimSize(pk, 33);
    ...
    crypto_sign_open_label8:for(loop=0;loop<message_len;loop++)
_ssdm_Unroll(0,0,0, "");
# 154 "api.c"
