...
set C_modelName {matrix_mul.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 32 regular {array 24 { 2 3 } 1 1 }  }
...
set portList { 
	...
	{ matrix_offset sc_in sc_lv 14 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 5 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 4 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 } } }
