...
chi::chi(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_x_8_fu_282_p2);
    sensitive << ( x_1_reg_114 );
    ...
    sc_trace(mVcdFile, x_8_fu_282_p2, "x_8_fu_282_p2");
    sc_trace(mVcdFile, x_8_reg_355, "x_8_reg_355");
...
void chi::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state6.read())) {
        x_8_reg_355 = x_8_fu_282_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void chi::thread_x_8_fu_282_p2() {
    x_8_fu_282_p2 = (!x_1_reg_114.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(x_1_reg_114.read()) + sc_biguint<3>(ap_const_lv3_1));
}
