...
architecture behav of mpc_AND_verify_2 is 
    ...
    signal shl_ln66_6_fu_299_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    crypto_sign_open_hbi_U74 : component crypto_sign_open_hbi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    crypto_sign_open_hbi_U75 : component crypto_sign_open_hbi
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    shl_ln66_6_fu_299_p2 <= std_logic_vector(shift_left(unsigned(xor_ln752_3_reg_410),to_integer(unsigned('0' & zext_ln54_11_reg_403(8-1 downto 0)))));
    ...
    view1_communicatedBi_d0 <= (shl_ln66_6_fu_299_p2 or and_ln66_fu_303_p2);
