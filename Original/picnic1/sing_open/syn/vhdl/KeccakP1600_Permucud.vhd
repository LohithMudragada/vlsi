...
entity KeccakP1600_Permucud_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 25
...
architecture rtl of KeccakP1600_Permucud_rom is 
...
entity KeccakP1600_Permucud is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of KeccakP1600_Permucud is
    component KeccakP1600_Permucud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    KeccakP1600_Permucud_rom_U :  component KeccakP1600_Permucud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
