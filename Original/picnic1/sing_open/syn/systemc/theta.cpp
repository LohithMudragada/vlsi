...
theta::theta(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_shl_ln1_fu_387_p3);
    sensitive << ( y_1_reg_159 );
    ...
    sc_trace(mVcdFile, shl_ln1_fu_387_p3, "shl_ln1_fu_387_p3");
...
void theta::thread_add_ln345_fu_404_p2() {
    add_ln345_fu_404_p2 = (!shl_ln1_fu_387_p3.read().is_01() || !zext_ln345_4_fu_400_p1.read().is_01())? sc_lv<5>(): (sc_biguint<5>(shl_ln1_fu_387_p3.read()) + sc_biguint<5>(zext_ln345_4_fu_400_p1.read()));
}
...
void theta::thread_shl_ln1_fu_387_p3() {
    shl_ln1_fu_387_p3 = esl_concat<3,2>(y_1_reg_159.read(), ap_const_lv2_0);
}
