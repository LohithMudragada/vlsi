...
wire   [7:0] loop_37_fu_299_p2;
reg   [7:0] loop_37_reg_508;
wire    ap_CS_fsm_state4;
wire   [0:0] icmp_ln211_fu_293_p2;
reg   [7:0] instance_state_addr_2_reg_518;
wire   [63:0] j_3_fu_339_p2;
reg   [63:0] j_3_reg_523;
...
reg   [7:0] offset_assign_8_reg_142;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln211_fu_293_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        instance_state_addr_2_reg_518 <= zext_ln212_fu_305_p1;
    end
end
...
assign add_ln232_2_fu_423_p2 = (instance_byteIOIndex_fu_56 + loop_1_reg_153);
...
assign i_fu_388_p2 = (zext_ln229_2_fu_384_p1 + i_13_load_reg_476);
...
assign icmp_ln211_fu_293_p2 = ((offset_assign_8_reg_142 == 8'd168) ? 1'b1 : 1'b0);
...
assign j_3_fu_339_p2 = ($signed(j_0_reg_120) + $signed(64'd18446744073709551448));

assign j_fu_252_p2 = (34'd32 - i_13_fu_52);

assign loop_37_fu_299_p2 = (offset_assign_8_reg_142 + 8'd1);

assign loop_fu_398_p2 = (loop_1_reg_153 + 32'd1);

assign p_2_rec_fu_454_p2 = (ap_phi_mux_p_1_rec_pn_phi_fu_167_p6 + p_01_rec_reg_108);

assign partialBlock_2_fu_366_p2 = (32'd168 - instance_byteIOIndex_fu_56);

assign partialBlock_fu_266_p2 = ($signed(6'd32) - $signed(trunc_ln223_fu_262_p1));

assign select_ln224_fu_372_p3 = ((icmp_ln224_fu_360_p2[0:0] === 1'b1) ? partialBlock_2_fu_366_p2 : zext_ln223_fu_351_p1);

assign sub_ln216_fu_282_p2 = (34'd32 - trunc_ln216_fu_278_p1);

assign tmp_fu_214_p4 = {{i_13_fu_52[33:5]}};

assign trunc_ln194_2_fu_324_p1 = p_01_rec_reg_108[6:0];

assign trunc_ln194_fu_408_p1 = p_01_rec_reg_108[6:0];

assign trunc_ln195_fu_236_p1 = i_13_fu_52[29:0];

assign trunc_ln206_fu_314_p1 = p_1_rec_reg_130[6:0];

assign trunc_ln212_fu_310_p1 = offset_assign_8_reg_142[6:0];

assign trunc_ln216_fu_278_p1 = j_0_reg_120[33:0];

assign trunc_ln223_fu_262_p1 = i_13_fu_52[5:0];

assign trunc_ln232_fu_404_p1 = loop_1_reg_153[6:0];

assign zext_ln149_fu_429_p1 = add_ln232_2_fu_423_p2;

assign zext_ln206_fu_258_p1 = j_fu_252_p2;

assign zext_ln212_2_fu_334_p1 = add_ln212_1_fu_328_p2;

assign zext_ln212_fu_305_p1 = offset_assign_8_reg_142;
