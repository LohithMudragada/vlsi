...
// ==============================================================
# 1 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c"
# 1 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c" 2
...
# 9 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c" 2
...
# 10 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c" 2
...
# 5 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/aes.h" 2
...
# 11 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c" 2
...
# 54 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c"
int
seedexpander_init(AES_XOF_struct *ctx,
                  unsigned char *seed,
                  unsigned char *diversifier,
...
# 251 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c"
        if ( xlen > 15 ) {
...
randombytes_sign(unsigned char *x, unsigned long long xlen)
{
    ...
    int i = 0;
        ...
        AES256_ECB(DRBG_ctx.Key, DRBG_ctx.V, block);
# 301 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c"
         int loop;
         for (loop=0;loop<16;loop++)
          x[i+loop] = block[loop];
            i += 16;
            xlen -= 16;
# 315 "C:/Users/Sanil/Downloads/Project/Original/NIST-KATs/rng.c"
    AES256_CTR_DRBG_Update(((void*)0), DRBG_ctx.Key, DRBG_ctx.V);
    DRBG_ctx.reseed_counter++;
