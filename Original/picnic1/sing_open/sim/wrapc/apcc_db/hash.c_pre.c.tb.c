...
static  char aesl_internal__OC_str[45] = "%s: Keccak_HashSqueeze failed (returned %d)\n";
...
printf("\n  %%2 = tail call zeroext i2 @Keccak_HashSqueeze(%%struct.Keccak_HashInstance* %%ctx, i8* %%digest, i64 %%1) nounwind, !dbg !14 for 0x%I64xth hint within @HashSqueeze  --> \n", ++aesl_llvm_cbe_143_count);
  llvm_cbe_tmp__43 = (unsigned char ) /*tail*/ Keccak_HashSqueeze((l_struct_OC_Keccak_HashInstance *)llvm_cbe_ctx, ( char *)llvm_cbe_digest, llvm_cbe_tmp__42);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%I64X",llvm_cbe_tmp__42);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__43);
}
  if (((llvm_cbe_tmp__43&3U) == (((unsigned char )0)&3U))) {
...
llvm_cbe_tmp__49:
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !14 for 0x%I64xth hint within @HashSqueeze  --> \n", ++aesl_llvm_cbe_149_count);
  llvm_cbe_tmp__44 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__44);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds %%struct._iobuf* %%5, i64 2, !dbg !14 for 0x%I64xth hint within @HashSqueeze  --> \n", ++aesl_llvm_cbe_150_count);
  llvm_cbe_tmp__45 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__44[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = zext i2 %%2 to i32, !dbg !14 for 0x%I64xth hint within @HashSqueeze  --> \n", ++aesl_llvm_cbe_151_count);
  llvm_cbe_tmp__46 = (unsigned int )((unsigned int )(unsigned char )llvm_cbe_tmp__43&3U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__46);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%6, i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @aesl_internal___func__.HashSqueeze, i64 0, i64 0), i32 %%7) nounwind, !dbg !14 for 0x%I64xth hint within @HashSqueeze  --> \n", ++aesl_llvm_cbe_152_count);
   /*tail*/ fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__45, ( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 45
#endif
])), ( char *)((&aesl_internal___func___OC_HashSqueeze[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 12
#endif
])), llvm_cbe_tmp__46);
...
printf("\n  %%1 = trunc i16 %%x to i8, !dbg !13 for 0x%I64xth hint within @HashUpdateIntLE  --> \n", ++aesl_llvm_cbe_167_count);
  llvm_cbe_tmp__50 = (unsigned char )((unsigned char )llvm_cbe_x&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__50);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [2 x i8]* %%temp, i64 0, i64 0, !dbg !13 for 0x%I64xth hint within @HashUpdateIntLE  --> \n", ++aesl_llvm_cbe_168_count);
  llvm_cbe_tmp__51 = ( char *)(&llvm_cbe_temp[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 2
#endif
]);
...
printf("\n  %%3 = lshr i16 %%x, 8, !dbg !14 for 0x%I64xth hint within @HashUpdateIntLE  --> \n", ++aesl_llvm_cbe_170_count);
  llvm_cbe_tmp__52 = (unsigned short )((unsigned short )(((unsigned short )(((unsigned short )(llvm_cbe_x&65535ull)) >> ((unsigned short )(((unsigned short )8)&65535ull))))));
if (AESL_DEBUG_TRACE)
...
printf("\n  %%5 = getelementptr inbounds [2 x i8]* %%temp, i64 0, i64 1, !dbg !14 for 0x%I64xth hint within @HashUpdateIntLE  --> \n", ++aesl_llvm_cbe_172_count);
  llvm_cbe_tmp__54 = ( char *)(&llvm_cbe_temp[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 2
#endif
]);
...
printf("\n  call void @HashUpdate(%%struct.Keccak_HashInstance* %%ctx, i8* %%2, i64 2), !dbg !13 for 0x%I64xth hint within @HashUpdateIntLE  --> \n", ++aesl_llvm_cbe_174_count);
  HashUpdate((l_struct_OC_Keccak_HashInstance *)llvm_cbe_ctx, ( char *)llvm_cbe_tmp__51, 2ull);
if (AESL_DEBUG_TRACE) {
