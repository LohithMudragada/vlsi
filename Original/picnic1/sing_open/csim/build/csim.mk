...
HLS_SOURCES = ../../../../newtest_sign_2.c ../../../../tree.c ../../../../NIST-KATs/rng.c ../../../../picnic_types.c ../../../../picnic_impl.c ../../../../picnic2_impl.c ../../../../picnic.c ../../../../lowmc_constants.c ../../../../hash.c ../../../../api.c ../../../../NIST-KATs/aes.c ../../../../sha3/KeccakSpongeWidth1600.c ../../../../sha3/KeccakP-1600-reference.c ../../../../sha3/KeccakHash.c
...
$(ObjDir)/newtest_sign_2.o: ../../../../newtest_sign_2.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../newtest_sign_2.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/newtest_sign_2.d
