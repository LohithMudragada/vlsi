...
architecture rtl of verify_temp_ram is 
...
architecture arch of verify_temp is
    component verify_temp_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    verify_temp_ram_U :  component verify_temp_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
