...
module AESL_automem_viewOutputs (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.crypto_sign_open.autotvin_viewOutputs.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.crypto_sign_open.autotvout_viewOutputs.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 14;
parameter DEPTH = 32'd 10512;
parameter DLY = 0.1;
