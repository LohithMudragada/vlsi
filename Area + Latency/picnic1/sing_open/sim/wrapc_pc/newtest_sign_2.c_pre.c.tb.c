...
// ==============================================================
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
...
# 9 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
...
# 10 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
...
# 11 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
...
# 12 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
...
# 13 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
...
# 14 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c" 2
# 29 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
...
#endif
# 40 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
int
main()
{
    ...
    unsigned char m[3300], m1[3300], sm[3300+34036], sm_rsp[3300+34036];

    unsigned long long mlen, smlen, mlen1, smlen_rsp;
    int count;
    int done;
    unsigned char pk[33], sk[49];
    int ret_val;
    ...
    FILE *fp_rsp;
    FILE *fp_init;
    unsigned char pk_rsp[33], sk_rsp[49];
    ...
    sprintf(fn_rsp, "../../../../KAT/picnicl1fs/PQCsignKAT_L1.rsp");
    ...
    do {
     ...
     if(count_loop == 1) {
        ...
        if ( !ReadHex(fp_rsp, pk_rsp, 33, "pk = ") ) {
            printf("ERROR: unable to read 'pk' from <%s>\n", fn_rsp);
            return -3;
        }
        if ( !ReadHex(fp_rsp, sk_rsp, 49, "sk = ") ) {
            printf("ERROR: unable to read 'sk' from <%s>\n", fn_rsp);
            return -3;
        }


        if(memcmp(pk,pk_rsp,33)!=0){
     printf("ERR: pk is different from <%s>\n", fn_rsp);

 }
# 155 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
...
# 200 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
...
#endif
# 215 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
crypto_sign_open(m1, &mlen1, sm_rsp, smlen_rsp, pk_rsp))
...
#endif
# 240 "C:/Users/Sanil/Downloads/Project/Latency/Area/newtest_sign_2.c"
