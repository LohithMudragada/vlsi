# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 2
# 13 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
...
# 14 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 2
...
# 15 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 2
...
# 16 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 2
...
# 17 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 2
...
# 18 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c" 2
...
void allocateProof(proof_t* proof, paramset_t* params)
{
# 106 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
}

void freeProof(proof_t* proof)
{
# 118 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
}

void allocateSignature(signature_t* sig, paramset_t* params)
{
# 132 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
}

void freeSignature(signature_t* sig, paramset_t* params)
{
# 145 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
}

void allocateSignature2(signature2_t* sig, paramset_t* params)
{
    sig->salt = (uint8_t*)malloc(params->saltSizeBytes);
    sig->iSeedInfo = ((void*)0);
    sig->iSeedInfoLen = 0;
    sig->cvInfo = ((void*)0);
    sig->cvInfoLen = 0;
...
seeds_t* allocateSeeds(paramset_t* params)
{
    ...
    uint8_t* slab1 = malloc((params->numMPCRounds * nSeeds) * params->seedSizeBytes + params->saltSizeBytes);
    uint8_t* slab2 = malloc(params->numMPCRounds * nSeeds * sizeof(uint8_t*) + sizeof(uint8_t*) + params->numMPCRounds * sizeof(uint8_t*) );
    uint8_t* slab3 = malloc((params->numMPCRounds) * params->seedSizeBytes + params->saltSizeBytes);
    ...
    seeds[params->numMPCRounds].seed = ((void*)0);
    if (params->numMPCParties == 3) {
        seeds[params->numMPCRounds].iSeed = slab1;
    }
    else {
        seeds[params->numMPCRounds].iSeed = slab3;
    }
...
{
# 237 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.c"
