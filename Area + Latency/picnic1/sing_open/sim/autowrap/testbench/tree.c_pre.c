# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
# 14 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c"
...
# 15 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
...
# 16 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
...
# 17 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2

# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.h" 1
# 16 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.h"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_impl.h" 1
# 19 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_impl.h"
...
# 20 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_impl.h" 2
# 1 "C:/Xilinx/Vivado/2019.2/win64/tools/clang/bin/../lib/clang/3.1/include\\stddef.h" 1 3 4
...
# 17 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.h" 2
...
# 18 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic_types.h" 2
...
# 19 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
...
# 19 "C:/Users/Sanil/Downloads/Project/Latency/Area/sha3/KeccakSponge-common.h"
...
# 20 "C:/Users/Sanil/Downloads/Project/Latency/Area/sha3/KeccakSponge-common.h" 2
...
# 20 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic.h" 1
# 33 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic.h"
...
# 34 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic.h" 2
...
# 21 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
...
# 23 "C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c" 2
...
{
    (void) ((!!(node != 0)) || (_assert("node != 0","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",90),0));
    return(node % 2 == 1);
}
...
{
    (void) ((!!(node != 0)) || (_assert("node != 0","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",104),0));
...
uint8_t* getLeaf(tree_t* tree, size_t leafIndex)
{
    (void) ((!!(leafIndex < tree->numLeaves)) || (_assert("leafIndex < tree->numLeaves","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",119),0));
...
{
    (void) ((!!(node < tree->numNodes)) || (_assert("node < tree->numNodes","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",200),0));
    (void) ((!!(node != 0)) || (_assert("node != 0","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",201),0));
    (void) ((!!(hasSibling(tree, node))) || (_assert("hasSibling(tree, node)","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",202),0));
    ...
    if (isLeftChild(node)) {
        if (node + 1 < tree->numNodes) {
            ...
            (void) ((!!(!"getSibling: request for node with not sibling")) || (_assert("!\"getSibling: request for node with not sibling\"","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",209),0));
            return 0;
        }
    }
    else {
...
size_t revealSeeds(tree_t* tree, uint16_t* hideList, size_t hideListSize, uint8_t* output, size_t outputSize, paramset_t* params)
{
    ...
    for (size_t i = 0; i < revealedSize; i++) {
        ...
        if (outLen < 0) {
            (void) ((!!(!"Insufficient sized buffer provided to revealSeeds")) || (_assert("!\"Insufficient sized buffer provided to revealSeeds\"","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",321),0));
            free(revealed);
            return 0;
        }
...
int addMerkleNodes(tree_t* tree, uint16_t* missingLeaves, size_t missingLeavesSize, uint8_t* input, size_t inputSize)
{
    ...
    (void) ((!!(missingLeavesSize < tree->numLeaves)) || (_assert("missingLeavesSize < tree->numLeaves","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",517),0));
    ...
    size_t revealedSize = 0;
    size_t* revealed = getRevealedMerkleNodes(tree, missingLeaves, missingLeavesSize, &revealedSize);
    (void) ((!!(!contains(revealed, revealedSize, 0))) || (_assert("!contains(revealed, revealedSize, 0)","C:/Users/Sanil/Downloads/Project/Latency/Area/tree.c",526),0));
