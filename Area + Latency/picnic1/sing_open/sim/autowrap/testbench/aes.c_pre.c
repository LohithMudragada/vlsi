# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c" 2
# 38 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
...
# 39 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c" 2
...
# 40 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.h" 1
# 43 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.h"
struct AES_ctx
{
...
# 74 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.h"
void AES_CBC_encrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
# 87 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.h"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
# 41 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c" 2
# 80 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
...
# 152 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
static void KeyExpansion(uint8_t* RoundKey, const uint8_t* Key)
{
  ...
  KeyExpansion_label4:for (i = 0; i < 8; ++i)
  {
  ...
  KeyExpansion_label5:for (i = 8; i < 4 * (14 + 1); ++i)
  {
    {
      k = (i - 1) * 4;
...
{
  uint8_t i, j;
  SubBytes_label1:for (i = 0; i < 4; ++i)
  {
    SubBytes_label0:for (j = 0; j < 4; ++j)
    {
...
static void MixColumns(state_t* state)
{
  uint8_t i;
  uint8_t Tmp, Tm, t;
  MixColumns_label2:for (i = 0; i < 4; ++i)
  {
    t = (*state)[i][0];
...
# 348 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
...
static void Cipher(state_t* state, uint8_t RoundKey[240])
{
  ...
  Cipher_label3:for (round = 1; round < 14; ++round)
  {
    SubBytes(state);
    ShiftRows(state);
    MixColumns(state);
...
# 469 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
void AES_ECB_encrypt(struct AES_ctx *ctx, state_t* buf)
{
...
# 492 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
...
# 539 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/aes.c"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length)
{
  uint8_t buffer[16];
