...
// ==============================================================
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c" 2
# 12 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c"
...
# 21 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.h" 2
...
# 13 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c" 2
...
# 14 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c" 2
...
# 15 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/sha3/brg_endian.h" 1
# 16 "C:/Users/Sanil/Downloads/Project/Latency/Area/hash.c" 2
...
void HashInit(HashInstance* ctx, paramset_t* params, uint8_t hashPrefix)
{
 ...
 temp[0] = hashPrefix;
    if (params->stateSizeBits == 128) {
        Keccak_HashInitialize(ctx, 1344, 256, 0, 0x1F);
    }
    else {
        Keccak_HashInitialize(ctx, 1088, 512, 0, 0x1F);
    }
...
void HashFinal(HashInstance* ctx)
{
    HashReturn ret = Keccak_HashFinal(ctx, ((void*)0));
...
void HashSqueeze(HashInstance* ctx, uint8_t* digest, size_t byteLen)
{
    ...
    if (ret != SUCCESS) {
        fprintf((&__iob_func()[2]), "%s: Keccak_HashSqueeze failed (returned %d)\n", __func__, ret);
    }
}
