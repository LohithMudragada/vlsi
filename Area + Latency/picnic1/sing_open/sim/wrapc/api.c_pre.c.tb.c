...
// ==============================================================
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c" 2
# 12 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c"
# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic.h" 1
# 32 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic.h"
...
# 33 "C:/Users/Sanil/Downloads/Project/Latency/Area/picnic.h" 2
...
# 11 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/rng.h"
...
# 12 "C:/Users/Sanil/Downloads/Project/Latency/Area/NIST-KATs/rng.h" 2
...
# 13 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c" 2

# 1 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.h" 1
# 27 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.h"
int
...
# 15 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c" 2
...
# 21 "C:/Users/Sanil/Downloads/Project/Latency/Area/api.c" 2
...
int crypto_sign_keypair(unsigned char pk[33], unsigned char sk[49])
{
    ...
    ret = picnic_write_public_key(&pubkey, pk, 33);
    if (ret < 1) {
        return ret;
    }

    ret = picnic_write_private_key(&secret, sk, 49);
    if (ret < 1) {
        return ret;
    }
...
int crypto_sign(unsigned char sm[3300+34036], unsigned long long smlen[1],
                const unsigned char m[3300], unsigned long long mlen,
                const unsigned char sk[49])
{
    picnic_privatekey_t secret;
    int loop;

    int ret = picnic_read_private_key(&secret, sk, 49);
...
int crypto_sign_open(unsigned char m[3300], unsigned long long mlen[1],
                     const unsigned char sm[3300+34036], unsigned long long smlen,
                     const unsigned char pk[33])
{
    picnic_publickey_t pubkey[1];
    int loop;

    int ret = picnic_read_public_key(pubkey, pk, 33);
