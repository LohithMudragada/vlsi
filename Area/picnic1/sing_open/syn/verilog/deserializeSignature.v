...
wire   [7:0] i_20_fu_598_p2;
reg   [7:0] i_20_reg_1486;
...
wire   [4:0] loop_37_fu_1406_p2;
reg   [4:0] loop_37_reg_1715;
...
wire   [12:0] tmp_19_fu_939_p3;
wire   [5:0] trunc_ln54_8_fu_963_p4;
wire   [1:0] trunc_ln386_6_fu_978_p1;
wire   [2:0] bitNumber_assign_4_fu_982_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state21) & (tmp_63_fu_1284_p3 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state21) & (tmp_63_fu_1284_p3 == 1'd0))) begin
...
assign bitNumber_assign_4_fu_982_p3 = {{trunc_ln386_6_fu_978_p1}, {1'd0}};
...
assign i_20_fu_598_p2 = (round_assign_reg_408 + 8'd1);

assign i_21_fu_794_p2 = (round_assign_2_reg_431 + 8'd1);

assign i_fu_957_p2 = (round_assign_3_reg_466 + 8'd1);
...
assign icmp_ln1951_fu_788_p2 = ((round_assign_2_reg_431 < 8'd219) ? 1'b1 : 1'b0);
...
assign icmp_ln2052_fu_951_p2 = ((round_assign_3_reg_466 == 8'd219) ? 1'b1 : 1'b0);
...
assign loop_32_fu_886_p2 = (loop_1_reg_442 + 6'd1);

assign loop_33_fu_1057_p2 = (loop_2_reg_490 + 6'd1);

assign loop_34_fu_1106_p2 = (loop_3_reg_501 + 7'd1);

assign loop_35_fu_1156_p2 = (loop_4_reg_512 + 5'd1);

assign loop_36_fu_1210_p2 = (loop_5_reg_524 + 5'd1);

assign loop_37_fu_1406_p2 = (5'd4 + loop_6_reg_535);
...
assign tmp_19_fu_939_p3 = {{round_assign_3_reg_466}, {5'd0}};

assign tmp_20_fu_1431_p3 = {{round_assign_3_reg_466}, {trunc_ln2087_4_reg_1710}};

assign tmp_63_fu_1284_p3 = loop_6_reg_535[32'd4];

assign tmp_fu_1258_p4 = {{add_ln2084_fu_1253_p2[2:1]}};

assign tmp_s_fu_927_p3 = {{round_assign_3_reg_466}, {4'd0}};
...
assign trunc_ln386_4_fu_800_p1 = round_assign_2_reg_431[1:0];

assign trunc_ln386_5_fu_842_p1 = lshr_ln54_9_fu_836_p2[0:0];

assign trunc_ln386_6_fu_978_p1 = round_assign_3_reg_466[1:0];
...
assign trunc_ln54_6_fu_804_p4 = {{round_assign_2_reg_431[7:2]}};

assign trunc_ln54_8_fu_963_p4 = {{round_assign_3_reg_466[7:2]}};
...
assign xor_ln54_5_fu_990_p2 = (bitNumber_assign_4_fu_982_p3 ^ 3'd6);

assign xor_ln54_6_fu_1010_p2 = (bitNumber_assign_4_fu_982_p3 ^ 3'd7);
...
assign zext_ln2052_fu_947_p1 = tmp_19_fu_939_p3;
...
assign zext_ln2087_12_fu_1438_p1 = tmp_20_fu_1431_p3;
