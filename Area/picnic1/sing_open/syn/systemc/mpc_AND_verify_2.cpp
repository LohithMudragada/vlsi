...
mpc_AND_verify_2::mpc_AND_verify_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    crypto_sign_open_g8j_U71 = new crypto_sign_open_g8j<1,1,8,8,16,16>("crypto_sign_open_g8j_U71");
    crypto_sign_open_g8j_U71->din0(grp_fu_351_p0);
    crypto_sign_open_g8j_U71->din1(grp_fu_351_p1);
    crypto_sign_open_g8j_U71->din2(zext_ln54_cast1_reg_372);
    crypto_sign_open_g8j_U71->dout(grp_fu_351_p3);
    crypto_sign_open_g8j_U72 = new crypto_sign_open_g8j<1,1,8,8,16,16>("crypto_sign_open_g8j_U72");
    crypto_sign_open_g8j_U72->din0(grp_fu_359_p0);
    crypto_sign_open_g8j_U72->din1(grp_fu_359_p1);
    crypto_sign_open_g8j_U72->din2(zext_ln54_cast1_reg_372);
    crypto_sign_open_g8j_U72->dout(grp_fu_359_p3);
    ...
    SC_METHOD(thread_shl_ln66_9_fu_299_p2);
    sensitive << ( zext_ln54_11_reg_403 );
    sensitive << ( xor_ln752_3_reg_410 );
    ...
    sensitive << ( shl_ln66_9_fu_299_p2 );
    ...
    sc_trace(mVcdFile, shl_ln66_9_fu_299_p2, "shl_ln66_9_fu_299_p2");
...
mpc_AND_verify_2::~mpc_AND_verify_2() {
    ...
    delete crypto_sign_open_g8j_U71;
    delete crypto_sign_open_g8j_U72;
}
...
void mpc_AND_verify_2::thread_shl_ln66_9_fu_299_p2() {
    shl_ln66_9_fu_299_p2 = (!zext_ln54_11_reg_403.read().is_01())? sc_lv<8>(): xor_ln752_3_reg_410.read() << (unsigned short)zext_ln54_11_reg_403.read().to_uint();
}
...
void mpc_AND_verify_2::thread_view1_communicatedBi_d0() {
    view1_communicatedBi_d0 = (and_ln66_fu_303_p2.read() | shl_ln66_9_fu_299_p2.read());
}
