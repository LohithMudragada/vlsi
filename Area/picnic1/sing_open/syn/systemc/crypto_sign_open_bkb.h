...
// ==============================================================
#ifndef __crypto_sign_open_bkb__HH__
#define __crypto_sign_open_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_open_bkb) {
    ...
    SC_CTOR(crypto_sign_open_bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
