...
pi::pi(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_shl_ln3_fu_148_p3);
    sensitive << ( y_0_reg_83 );
    ...
    sc_trace(mVcdFile, shl_ln3_fu_148_p3, "shl_ln3_fu_148_p3");
...
void pi::thread_add_ln362_fu_165_p2() {
    add_ln362_fu_165_p2 = (!shl_ln3_fu_148_p3.read().is_01() || !zext_ln362_3_fu_161_p1.read().is_01())? sc_lv<5>(): (sc_biguint<5>(shl_ln3_fu_148_p3.read()) + sc_biguint<5>(zext_ln362_3_fu_161_p1.read()));
}
...
void pi::thread_shl_ln3_fu_148_p3() {
    shl_ln3_fu_148_p3 = esl_concat<3,2>(y_0_reg_83.read(), ap_const_lv2_0);
}
