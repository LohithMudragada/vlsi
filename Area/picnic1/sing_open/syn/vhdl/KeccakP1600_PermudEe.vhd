...
entity KeccakP1600_PermudEe_rom is 
    generic(
             DWIDTH     : integer := 64; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 24
...
architecture rtl of KeccakP1600_PermudEe_rom is 
...
entity KeccakP1600_PermudEe is
    generic (
...
architecture arch of KeccakP1600_PermudEe is
    component KeccakP1600_PermudEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    KeccakP1600_PermudEe_rom_U :  component KeccakP1600_PermudEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
