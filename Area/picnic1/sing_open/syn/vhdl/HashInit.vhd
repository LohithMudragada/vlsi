...
architecture behav of HashInit is 
    ...
    signal grp_KeccakWidth1600_Spon_9_fu_74_ap_start : STD_LOGIC;
    signal grp_KeccakWidth1600_Spon_9_fu_74_ap_done : STD_LOGIC;
    signal grp_KeccakWidth1600_Spon_9_fu_74_ap_idle : STD_LOGIC;
    signal grp_KeccakWidth1600_Spon_9_fu_74_ap_ready : STD_LOGIC;
    signal grp_KeccakWidth1600_Spon_9_fu_74_instance_state_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_KeccakWidth1600_Spon_9_fu_74_instance_state_ce0 : STD_LOGIC;
    signal grp_KeccakWidth1600_Spon_9_fu_74_instance_state_we0 : STD_LOGIC;
    signal grp_KeccakWidth1600_Spon_9_fu_74_instance_state_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_KeccakWidth1600_Spon_9_fu_74_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_KeccakWidth1600_Spon_9_fu_74_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_KeccakWidth1600_Spon_9_fu_74 : component KeccakWidth1600_Spon_9
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_KeccakWidth1600_Spon_9_fu_74_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_KeccakWidth1600_Spon_9_fu_74_ap_ready = ap_const_logic_1)) then 
                    grp_KeccakWidth1600_Spon_9_fu_74_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_block_state3_on_subcall_done_assign_proc : process(icmp_ln66_reg_122, grp_KeccakWidth1600_Spon_9_fu_74_ap_done)
    begin
                ap_block_state3_on_subcall_done <= ((icmp_ln66_reg_122 = ap_const_lv1_0) and (grp_KeccakWidth1600_Spon_9_fu_74_ap_done = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_ctx_sponge_byteIOInd_phi_fu_67_p4_assign_proc : process(icmp_ln66_reg_122, grp_KeccakWidth1600_Spon_9_fu_74_ap_return, ctx_sponge_byteIOInd_reg_63, ap_CS_fsm_state3)
    begin
    ...
    ctx_sponge_state_address0_assign_proc : process(ap_CS_fsm_state2, icmp_ln66_reg_122, icmp_ln139_fu_86_p2, grp_KeccakWidth1600_Spon_9_fu_74_instance_state_address0, ap_CS_fsm_state3, zext_ln140_fu_98_p1)
    begin
    ...
    ctx_sponge_state_ce0_assign_proc : process(ap_CS_fsm_state2, icmp_ln66_reg_122, icmp_ln139_fu_86_p2, grp_KeccakWidth1600_Spon_9_fu_74_instance_state_ce0, ap_CS_fsm_state3)
    begin
        if (((icmp_ln139_fu_86_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ctx_sponge_state_d0_assign_proc : process(ap_CS_fsm_state2, icmp_ln66_reg_122, icmp_ln139_fu_86_p2, grp_KeccakWidth1600_Spon_9_fu_74_instance_state_d0, ap_CS_fsm_state3)
    begin
        if (((icmp_ln139_fu_86_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ctx_sponge_state_we0_assign_proc : process(ap_CS_fsm_state2, icmp_ln66_reg_122, icmp_ln139_fu_86_p2, grp_KeccakWidth1600_Spon_9_fu_74_instance_state_we0, ap_CS_fsm_state3)
    begin
        if (((icmp_ln139_fu_86_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_KeccakWidth1600_Spon_9_fu_74_ap_start <= grp_KeccakWidth1600_Spon_9_fu_74_ap_start_reg;
