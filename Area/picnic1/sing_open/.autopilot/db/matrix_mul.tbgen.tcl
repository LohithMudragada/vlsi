...
set C_modelArgList {
	{ output_r int 32 regular {array 24 { 0 3 } 0 1 }  }
	{ output_offset int 5 regular  }
	{ state int 32 regular {array 876 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 5 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 4 }  { output_r_d0 mem_din 1 32 } } }
	output_offset { ap_none {  { output_offset in_data 0 5 } } }
	state { ap_memory {  { state_address0 mem_address 1 10 }  { state_ce0 mem_ce 1 1 }  { state_q0 mem_dout 0 32 } } }
