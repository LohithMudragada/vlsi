...
wire   [15:0] tmp_34_cast_fu_318_p3;
reg   [15:0] tmp_34_cast_reg_614;
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        tmp_34_cast_reg_614[15 : 5] <= tmp_34_cast_fu_318_p3[15 : 5];
    end
end
...
assign add_ln394_8_fu_593_p2 = (tmp_34_cast_reg_614 + zext_ln394_9_fu_589_p1);

assign add_ln394_9_fu_484_p2 = (tmp_34_cast_reg_614 + zext_ln394_11_fu_480_p1);
...
assign icmp_ln302_fu_369_p2 = ((tmp_67_fu_359_p4 == 29'd0) ? 1'b1 : 1'b0);
...
assign tmp_34_cast_fu_318_p3 = {{add_ln394_7_fu_312_p2}, {5'd0}};

assign tmp_67_fu_359_p4 = {{i_35_fu_74[33:5]}};
...
always @ (posedge ap_clk) begin
    tmp_34_cast_reg_614[4:0] <= 5'b00000;
